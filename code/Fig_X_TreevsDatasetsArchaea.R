...
archDatset$Busi <- gsub("Busi", "Busi et al., Nat Com, 2022", archDatset$Busi)
archDatset$ENSEMBLE <- gsub("ENSEMBLE", "Michoud et al, L&O, 2023", archDatset$ENSEMBLE)
archDatset$Tibet <- gsub("Tibet", "Tibetan Glacier Genome and Gene", archDatset$Tibet)
...
p3_arch <- gheatmap(p2_arch, archDatset,
...
ggsave_fitmax("Figures/Fig_X_ArchaealTree.pdf",
       p4_arch,
       maxwidth = 9)
