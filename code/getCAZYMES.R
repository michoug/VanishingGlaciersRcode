...
setwd("~/../switchdrive/Institution/NOMIS_MAGs/Prokaryotes/CAZymes_Sulfatase/")
...
dat_cazy_mags <-dat_select %>%
  ...
  separate_rows(CAZy)%>%
  right_join(element_sep, by =c("CAZy" = "CAZyme"), multiple = "all",relationship = "many-to-many")%>%
...
ggsave_fitmax("Figures/CAZymes_Element_cluster.pdf", p1, maxwidth = 15)
